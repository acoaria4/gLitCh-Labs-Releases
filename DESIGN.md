...
Bio brand name (`.get-brand-name`): Satoshi, `1.8rem`, weight 500, `letter-spacing: 0.08em`, under the finalized squircle on both Expenses and AURA.
...
| `assets/finalized-icons/lumen-metallic-enamel.png` | Lumen site icon |
