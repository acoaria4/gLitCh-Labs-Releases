...
version: 1
slug: "aura-get"
primary_target: "aura/get"
related_targets: []
---

# aura/get — Instagram bio

**Mode:** Persuade
**Audience:** Instagram visitors tapping the AURA bio.
...
**Direction:** Ivory-field trial. Phone-width column in 100dvh on plate cream `#f2ede5`. AURA ivory squircle + Satoshi brand name, one sentence, Play (blocked / Soon, primary) then App Store (TestFlight / Beta, secondary) — same order as Expenses. Tiny gLitCh Labs credit. Revert to dark bio at `8592488` if the trial fails.
